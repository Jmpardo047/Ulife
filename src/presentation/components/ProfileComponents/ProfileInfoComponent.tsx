...
export const ProfileInfo = () => {
    return (
        <div className="w-full h-min">
            <InfoBanner userPhoto={"https://s3.amazonaws.com/prod-wp-tunota/wp-content/uploads/2024/11/canguro-foto-en-el-espejo.jpg"} userName="John Jairo" friends="4 amigos"/>
